...
const ButtonArgumentValidations = {
  size: {
    presence: {
      presence: true
    },
    inclusion: {
      in: ['small', 'large', 'medium']
    }
  }
};
...
const checkArguments = (componentName, componentArguments, argumentValidationObject) => {
...
export default class ButtonComponent extends Component {
  constructor(owner, args) {
    ...
    checkArguments(this.constructor.name, args, ButtonArgumentValidations);
  }
}
